...
|---|---|---|
| `$377 raw (up $30 in one month)` | "sitting around three hundred seventy seven dollars raw, and it just jumped another thirty bucks this month" | ✅ |
| `Cynthia's Garchomp ex: $237` | "Cynthia's Garchomp ex is at two thirty seven" | ✅ |
| `Ethan's Ho-Oh ex: just under $200` | "Ethan's Ho-Oh ex is just under two hundred" | ✅ |
| `Vintage PSA 10 cards have risen 23%` | "vintage PSA ten cards are up twenty three percent" | ✅ |
