...
| Document context tasks | A sealed document pack at one operating window, collected with `fitr run --context-tiers`; CLI, JSON and HTML; not a role floor | [Context quality](docs/context-quality.md), [usage](docs/usage.md#document-context-tasks) |
